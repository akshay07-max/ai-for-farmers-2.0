// ================================================================
// KRISHIMITRA AI — MAIN SERVER FILE (Step 4 update)
// ================================================================
...
const weatherRoutes = require("./modules/weather/weather.routes"); // ← Step 4
...
app.use("/api/v1/weather", weatherRoutes); // ← Step 4
